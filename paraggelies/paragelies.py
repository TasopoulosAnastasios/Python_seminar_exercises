paragelies = """4,4,4,5,2,3,8,6,3,2,5,1,5,9,8,6,5,2,9,10,10,2,4,2,2,5,4,4,4,5,5,1,4,10,9,10,5
...
paragelies_list = []
for i in paragelies_list_s:
    paragelies_list.append(int(i))
...
for i in paragelies_list:
    if i not in temp_list:
        ...
        temp_list.append(i)
        print("to proin {} exei paraggelthei {} fores ".format(i,freq))
